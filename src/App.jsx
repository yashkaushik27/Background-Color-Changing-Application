...
<div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
 ...
 <button onClick={()=>setColor("lavender")} className="outline-none px-4 py-1 rounded-full text-white shadow-lg" style={{backgroundColor:"#dd5b5b"}}>Lavender</button> 
 <button onClick={()=>setColor("white")} className="outline-none px-4 py-1 rounded-full text-white shadow-lg" style={{backgroundColor:"#888f6176"}}>White</button> 
